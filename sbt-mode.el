...
buffer called *sbt*projectdir."
  (let* ((project-root (or (sbt:find-root)
         ...
         ;; WORKAROUND https://github.com/jline/jline2/pull/285 HVes:
         ;; This workaround is bogus. Do not re-add it. It turns on
         ;; echo which causes problems for comint, especially
         ;; comint-redirect-results-list which is used for
         ;; completions.
